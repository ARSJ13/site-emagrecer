...
$txtAssunto = "Contato Site EcoCerrado";
...
$corpoMensagem = "<b>Nome:</b> ".$txtNome."<br>Telefone:</b> ".$txtTelefone." <br><b>Assunto:</b> ".$txtAssunto."<br><b>Mensagem:</b> ".$txtMensagem;
...
if (smtpmailer('avivaldo.ribeiro@gmail.com', $txtNome, $txtAssunto, $corpoMensagem)) {
    Header("location: ../index.html"); // Redireciona para uma página de Sucesso.
}
if (!empty($error)) {
    echo $error;
}
